    ...
    <div x-transition:enter="transition ease-out duration-150"
        ...
        <form>
            <div class="mt-4 mb-6">
                ...
                <!-- <select class="block w-full mt-4 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" id="is_star" wire:model="is_star">
                    <option value="">Is this a star subject?</option>
