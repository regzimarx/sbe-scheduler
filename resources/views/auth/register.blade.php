                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <label class="block text-sm mb-2">
                                ...
                                <input
                                    ...
                                    placeholder="Jane Doe" type="text" name="first_name" :value="old('first_name')"
                            ...
                            <label class="block text-sm mb-2">
                                ...
                                <input
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="Jane Doe" type="text" name="middle_name" :value="old('middle_name')"
                            ...
                            <label class="block text-sm mb-2">
                                ...
                                <input
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="Jane Doe" type="text" name="last_name" :value="old('last_name')"
                            ...
                            <label class="block mt-4 text-sm mb-2">
                                ...
                                @include('includes.department_select')
                            </label>
                            <label class="block mt-4 text-sm mb-2">
